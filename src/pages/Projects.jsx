    ...
    <section className="py-16 bg-[#071B3A]">
      <div className="max-w-6xl mx-auto px-4 text-center">
        <p className="text-sm font-semibold text-white">
          <span className="mr-1 text-indigo-600">//</span> Our Latest Projects
        </p>
        ...
        <button
          ...
          className="mt-10 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-full transition"
        >
          {showAll ? "View Less Projects" : "View All Works"}
        </button>
      </div>
    </section>
  );
